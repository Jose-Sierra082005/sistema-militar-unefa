...
class EmailService
{
    ...
    public static function sendOtpEmail(string $email, string $name, string $otp): bool
    {
        ...
        <body>
            <div class="container">
                <div class="header">
                    <div class="title">SISTEMA MILITAR UNEFA</div>
                    <div class="subtitle">CONFIDENCIALIDAD Y SEGURIDAD NACIONAL</div>
                </div>
                <div class="content">
                    <p>Estimado Oficial <strong>' . htmlspecialchars($name) . '</strong>,</p>
                    <p>Se ha iniciado una solicitud de recuperación de contraseña de acceso para su cuenta registrada en la plataforma del Sistema Militar UNEFA Falcón.</p>
        ...
        try {
            $response = Http::withToken($apiKey)
                ...
                ->post('https://api.resend.com/emails', [
                    'from' => 'Sistema Militar <onboarding@resend.dev>',
                    'to' => [$email],
