 ...
 * inicio de sesión y recuperación del Doble Factor (2FA) en SIAM.
 */
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        $request->validate([
            ...
            'password.min' => 'Seguridad de SIAM: La clave debe tener al menos :min caracteres.',
        ]);
    ...
    public function register(Request $request)
    {
        ...
        $request->validate([
            ...
            'password.regex' => 'Seguridad de SIAM: La clave debe incluir al menos una letra mayúscula, una letra minúscula, un número y un carácter especial (@, $, !, %, *, ?, &).',
        ]);
