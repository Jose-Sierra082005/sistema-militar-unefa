...
@section('title', 'Mi Perfil | Sistema Militar UNEFA')
                        ...
                        <div class="tfa-ok-card">
                            ...
                            <div>
                                ...
                                <div style="font-size:.81rem;color:var(--text-secondary);line-height:1.5;">
                                    ...
                                    Abra la app, busque <strong style="color:var(--accent-gold);">Sistema Militar UNEFA</strong> e ingrese el c&oacute;digo de 6 d&iacute;gitos cuando se le solicite.
                                </div>
                            </div>
                        </div>
