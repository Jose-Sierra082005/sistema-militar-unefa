...
<head>
    ...
    <title>Establecer Nueva Contraseña - SIAM</title>
    ...
    <div class="login-card">
        ...
        <div style="text-align: center;">
            <div class="security-badge">
                <i class="fa-solid fa-user-lock"></i> Restablecer Clave
            </div>
        </div>
        ...
        <div class="header">
            ...
            <p class="subtitle">Establezca una clave de alta seguridad para su cuenta en SIAM.</p>
        </div>
        ...
        <form action="{{ route('password.reset') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div style="font-size: 0.72rem; color: var(--text-secondary); margin-top: 5px; line-height: 1.3;">
